...
const INITIAL_PROMOTIONS: Promotion[] = [
  { id: "1", title: "Ночной пакет", description: "Играй всю ночь с 22:00 до 08:00 по фиксированной цене.", validUntil: "2024-12-31", discount: "500 ₽" },
  { id: "2", title: "Студенческий", description: "Скидка 20% при предъявлении студенческого билета в будние дни до 18:00.", validUntil: "2024-06-30", discount: "-20%" },
  { id: "3", title: "День рождения", description: "3 часа игры бесплатно в день рождения (+/- 3 дня).", validUntil: "Бессрочно", discount: "Бесплатно" },
  { id: "4", title: "Приведи друга", description: "Получи 1 час игры за каждого приведенного друга, который купит пакет от 3 часов.", validUntil: "2024-12-31", discount: "1 час" },
];
